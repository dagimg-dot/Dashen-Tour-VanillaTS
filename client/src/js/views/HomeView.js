      ...
      <main>
            ...
            <div class="hero grid grid-2-cols">
                <div class="blur-wrap">
                    <div class="logo container-p">
                        <img src="./src/assets/icons/company-logo.svg" alt="company logo" />
                    </div>
                    <div class="hero-text-box container-p">
                        ...
                        <p class="hero-description">
                            Dashen tour is an ethiopian tour company dedicated to give you
                            the best trip you can imagine. We have helped tourists navigate
                            Ethiopia better. No regrets in choosing us.
                        </p>
                        <a href="#/signup" class="btn btn-fill margin-right-sm">Start exploring</a>
                        <a href="#" class="btn btn-outline">Learn more &rarr;</a>
                    </div>
                </div>
                <div class="unblurred-wrap">
                    <div class="socials container-p">
                        <a href="#" class="href"><img src="./src/assets/icons/facebook.svg" alt="facebook" /></a>
                        <a href="#" class="href"><img src="./src/assets/icons/instagram.svg" alt="instagram" /></a>
                        <a href="#" class="href"><img src="./src/assets/icons/twitter.svg" alt="twitter" /></a>
                        <a href="#" class="href"><img src="./src/assets/icons/youtube.svg" alt="youtube" /></a>
                    </div>
        ...
        <section class="section-top-dest">
            <div class="container-m">
                ...
                <h2 class="heading-secondary">
                    Some of the most popular and best locations that we provide package
                    to
                </h2>
            </div>
            <div class="container-m">
                <div class="destinations grid grid-2-cols grid-center-v">
                    ...
                    <div class="top-dest-text-box">
                        ...
                        <p class="top-dest-description">
                            Fasiledes Castle is located in the beautiful and historical city
                            of Gondar, a city in the amhara region. It is 650km away from
                            the capital city Addis Ababa. This tourist location has a plenty
                            of things to watch for like the whole city, the people, the
                            culture and so on.
                        </p>
                    </div>
                    <div class="top-dest-img-box">
                        <img src="./src/assets/images/destinations/007.jpg" alt="Picture of Gondar Fasiledes Castle"
                            class="top-dest-img" />
                    </div>
                    <!-- Top Destination 02 -->
                    <div class="top-dest-img-box">
                        <img src="./src/assets/images/destinations/011.jpg" alt="Picture of Gondar Fasiledes Castle"
                            class="top-dest-img" />
                    </div>
                    <div class="top-dest-text-box">
                        <p class="top-dest-number">፪</p>
                    ...
                    <div class="top-dest-img-box">
                        <img src="./src/assets/images/destinations/016.jpg" alt="Picture of Gondar Fasiledes Castle"
                            class="top-dest-img" />
                    </div>
                </div>
            </div>
        ...
        <section class="section-testimonials">
            <div class="testimonials-container">
                ...
                <div class="testimonials">
                    <figure class="testimonial">
                        <div>
                            <img class="testimonial-img" src="././src/assets/images/users/jd.png"
                    ...
                    <figure class="testimonial">
                        <div>
                            <img class="testimonial-img" src="././src/assets/images/users/abebe.png"
                                alt="Photo of customer Abebe Chala" />
                        </div>
                        <blockquote class="testimonial-text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Suscipit laudantium accusantium consectetur adipisicing elit.
                            Consequatur harum placeat numquam tempore modi culpa.
                        </blockquote>
                        <p class="testimonial-name">&mdash; Abebe Chala</p>
                    </figure>
                    <figure class="testimonial">
                        <div>
                            <img class="testimonial-img" src="././src/assets/images/users/elif.png"
                                alt="Photo of customer Abebe Chala" />
                        </div>
                        <blockquote class="testimonial-text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Suscipit cupiditate facilis alias volupta amet consectetur
                            adipisicing elit. Consequatur harum placeat numquam tempore modi
                            culpa.
                        </blockquote>
                    ...
                    <figure class="testimonial">
                        <div>
                            <img class="testimonial-img" src="././src/assets/images/users/jeremi.jpg"
                                alt="Photo of customer Abebe Chala" />
                        </div>
                        <blockquote class="testimonial-text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Suscipit laudantium accusantium enim vor sit amet consectetur
                            adipisicing elit. Consequatur harum placeat numquam tempore modi
                            culpa.
                        </blockquote>
            ...
            <div class="gallery">
                ...
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (13).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (6).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (7).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (14).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (9).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (10).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (11).jpg" alt="" />
                </figure>
                <figure class="gallery-item">
                    <img src="././src/assets/images/gallery/gallery (15).png" alt="" />
                </figure>
            </div>
        </section>
            ...
            <div class="container-m grid grid-3-cols">
                ...
                <div class="packages">
                    <div class="package-wrapper">
                        ...
                        <ul class="list">
                            <li class="list-item">
                                <svg class="list-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="section-featured">
            <div class="container-m">
                ...
                <div class="logos">
                    ...
                    <img src="./src/assets/images/companies/ministry_of_tourism.png" alt="">
                    <img src="./src/assets/images/companies/reporter_2.png" alt="">
                </div>
            </div>
        </section>
            ...
            <div class="container-m">
                <div class="cta">
                    <div class="cta-text-box">
                        <h2 class="heading-secondary">Do you have something to say ?</h2>
                        <p class="cta-text">
                        ...
                        <form action="#" class="cta-form">
                            <div>
                                <label for="select-what">What is the message about?</label>
                            ...
                            <div>
                                ...
                                <input id="full-name" type="text" placeholder="Jay Smith" required />
                            </div>
                            ...
                            <div>
                                ...
                                <input id="email" type="text" placeholder="your.email@example.com" required />
                            </div>

                            <div class="cta-text-area">
                                <label for="message">Message</label>
                                <textarea id="message" cols="30" rows="3" required></textarea>
                            </div>

                            <button class="btn btn-form">Send message</button>
                        </form>
                    </div>
                    <div class="cta-img-box" role="img" aria-label="Arba Minch Lodge"></div>
                </div>
            </div>
        </section>
  </main>
          ...
          <div class="container-m grid grid-footer">
              <div class="logo-col">
                  ...
                  <ul class="social-links">
                      <li>
                          <a class="footer-link" href="#" class="href"><img src="././src/assets/icons/facebook.svg"
                                  alt="facebook" /></a>
                      </li>
                      <li>
                          <a class="footer-link" href="#" class="href"><img src="././src/assets/icons/instagram.svg"
                                  alt="instagram" /></a>
                      </li>
                      <li>
                          <a class="footer-link" href="#" class="href"><img src="././src/assets/icons/twitter.svg"
                                  alt="twitter" /></a>
                      </li>
                      <li>
                          <a class="footer-link" href="#" class="href"><img src="././src/assets/icons/youtube.svg"
                                  alt="youtube" /></a>
                      </li>
                  </ul>
              </div>
              <div class="address-col">
                  ...
                  <address class="contacts">
                      ...
                      <p>
                          <a class="contact" href="mailto:dashentour@gmail.com">dashentour@gmail.com</a>
                      </p>
                  </address>
              </div>
              <nav class="nav-col">
